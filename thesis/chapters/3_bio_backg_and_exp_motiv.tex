...
\begin{figure}[!b]
    ...
    \caption[Circuits involved in \textit{Drosophila} sleep]{
        ...
        %!TODO!: Replicate image on the right and add connections from R5 to E-PG. Add text to caption
    }
...
For some neurons, they have been hypothesized and experimentally validated to play a substantial role in mediating bursting and low-threshold Ca$^{2+}$ spikes after sodium channels are blocked in the experimental conditions. %!TODO!: citations
...
Furthermore, the undershoot depends on the dynamical properties of the system, as it will be discussed in more detail in Section 2. %!TODO!: Add link
...
% !TODO!: (\textcolor{red}{see also Section ??? - Discussion}).
